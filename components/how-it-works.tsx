...
export function HowItWorks() {
  ...
  return (
    <section ref={containerRef} className="py-20 relative">
      {/* Animated background */}
      <motion.div
        className="absolute inset-0 bg-muted/50 z-0"
        initial={{ opacity: 0 }}
      ...
      <div className="container-narrow relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <AnimatedContent direction="left">
            <motion.div
              className="bg-background/80 backdrop-blur-sm rounded-xl p-8 shadow-sm hover-lift border border-border/50"
              whileHover={{
                y: -5,
            ...
            >
              <h3 className="text-2xl font-bold mb-6 flex items-center">
                <span className="bg-primary/10 text-primary p-2 rounded-lg mr-3">For Advertisers</span>
              </h3>
          ...
          <AnimatedContent direction="right" delay={0.2}>
            ...
            >
              <h3 className="text-2xl font-bold mb-6 flex items-center">
                <span className="bg-primary/10 text-primary p-2 rounded-lg mr-3">For Ad Buyers</span>
              </h3>
              <AnimatedList staggerDelay={0.15}>
                <Step
                  number={1}
